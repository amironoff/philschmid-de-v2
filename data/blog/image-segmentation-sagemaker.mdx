...
tags:
  ...
  - Sagemaker
draft: false
summary: Learn how to do image segmentation with Hugging Face Transformers, SegFormer and Amazon SageMaker.
repository: https://github.com/huggingface/notebooks/blob/main/sagemaker/21_image_segmantation/sagemaker-notebook.ipynb
---
