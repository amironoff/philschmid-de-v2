...
tags:
  ...
  - Inferentia
draft: false
summary: Learn how to accelerate BERT and Transformers inference using Hugging Face Transformers and AWS Inferentia.
repository: https://github.com/huggingface/notebooks/blob/master/sagemaker/18_inferentia_inference/sagemaker-notebook.ipynb
---
