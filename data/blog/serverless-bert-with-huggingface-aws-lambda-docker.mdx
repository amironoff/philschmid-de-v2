...
tags:
  ...
  - BERT
draft: false
summary: Learn how to use the newest cutting edge computing power of AWS with the benefits of serverless architectures to leverage Google's "State-of-the-Art" NLP Model.
repository: https://github.com/philschmid/serverless-bert-huggingface-aws-lambda-docker
---
