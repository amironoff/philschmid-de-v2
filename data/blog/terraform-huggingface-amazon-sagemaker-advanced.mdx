...
tags:
  ...
  - Terraform
draft: false
summary: Learn how to apply autoscaling to Hugging Face Transformers and Amazon SageMaker using Terraform.
repository: https://github.com/philschmid/terraform-aws-sagemaker-huggingface
---
