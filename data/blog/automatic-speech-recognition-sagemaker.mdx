...
tags:
  ...
  - Sagemaker
draft: false
summary: Learn how to do automatic speech recognition/speech-to-text with Hugging Face Transformers, Wav2vec2 and Amazon SageMaker.
images: ['/static/blog/automatic-speech-recognition-sagemaker/cover.jpg']
repository: https://github.com/huggingface/notebooks/blob/main/sagemaker/20_automatic_speech_recognition_inference/sagemaker-notebook.ipynb
---
