...
tags:
  ...
  - Docker
draft: false
summary: Learn how to build and deploy an AWS Lambda function with a custom python docker container as runtime with the use of Amazon ECR.
images: ['/static/blog/getting-started-habana-gaudi/cover.jpg']
repository: https://github.com/philschmid/aws-lambda-with-docker-image
---
