...
tags:
  ...
  - Inferentia
draft: false
summary: Learn how to accelerate Sentence Transformers inference inference using Hugging Face Transformers and AWS Inferentia.
repository: https://github.com/philschmid/sentence-transformers-huggingface-inferentia/blob/main/sagemaker-notebook.ipynb
---
