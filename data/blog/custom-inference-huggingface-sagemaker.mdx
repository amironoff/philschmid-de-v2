...
tags:
  ...
  - SageMaker
draft: false
summary: Learn how to use a custom Inference script for creating document embeddings with Hugging Face's Transformers, Amazon SageMaker, and Sentence Transformers.
images: ['/static/blog/custom-inference-huggingface-sagemaker/cover.jpg']
repository: https://github.com/huggingface/notebooks/blob/master/sagemaker/17_custom_inference_script/sagemaker-notebook.ipynb
---
