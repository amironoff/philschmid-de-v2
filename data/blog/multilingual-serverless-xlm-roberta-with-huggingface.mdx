...
tags:
  ...
  - BERT
draft: false
summary: Learn how to build a Multilingual Serverless BERT Question Answering API with a model size of more than 2GB and then testing it in German and France.
images: ['/static/blog/getting-started-habana-gaudi/cover.jpg']
repository: https://github.com/philschmid/multilingual-serverless-qa-aws-lambda
---
