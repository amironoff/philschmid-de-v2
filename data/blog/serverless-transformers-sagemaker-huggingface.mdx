...
tags:
  ...
  - Serverless
  - Sagemaker
summary: Learn how to deploy Hugging Face Transformers serverless using the new Amazon SageMaker Serverless Inference.
repository: https://github.com/philschmid/cdk-samples/tree/master/sagemaker-serverless-huggingface-endpoint
---
