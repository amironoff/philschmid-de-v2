...
tags:
  ...
  - PyTorch
draft: false
summary: Learn how to run apply task-specific knowledge distillation for BERT and text-classification using Hugging Face Transformers & Amazon SageMaker including Hyperparameter search.
repository: https://github.com/philschmid/knowledge-distillation-transformers-pytorch-sagemaker
---
