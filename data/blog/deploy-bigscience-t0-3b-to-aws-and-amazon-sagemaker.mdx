...
tags:
  ...
  - Sagemaker
draft: false
summary: 🌸 BigScience released their first modeling paper introducing T0 which outperforms GPT-3 on many zero-shot tasks while being 16x smaller! Deploy BigScience the 3 Billion version (T0_3B) to Amazon SageMaker with a few lines of code to run a scalable production workload!
images: ['/static/blog/deploy-bigscience-t0-3b-to-aws-and-amazon-sagemaker/cover.jpg']
---
