...
tags:
  ...
  - Quantization
draft: false
summary: Learn how to do post-training static quantization on Hugging Face Transformers model with `optimum` to achieve up to 3x latency improvements.
repository: https://github.com/philschmid/optimum-static-quantization/blob/master/notebook.ipynb
---
