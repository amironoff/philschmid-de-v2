...
tags:
  ...
  - SageMaker
draft: false
summary: Learn about the different existing Amazon SageMaker Inference options and and how to use them.
repository: https://github.com/philschmid/huggingface-sagemaker-workshop-series/blob/main/on-side-event/session_2_everything_to_know_for_deployment/session-notebook.ipynb
---
