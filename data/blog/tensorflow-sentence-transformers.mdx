...
_[Converting SentenceTransformers to Tensorflow](https://skeptric.com/sentencetransformers-to-tensorflow/) is another source by Edward Ross for Sentence Transformers with Tensorflow_
