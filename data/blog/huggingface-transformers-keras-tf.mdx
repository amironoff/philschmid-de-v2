...
tags:
  ...
  - Tensorflow
draft: false
summary: Learn how to fine-tune a non-English BERT using Hugging Face Transformers and Keras/TF, Transformers, datasets.
repository: https://github.com/philschmid/transformers-keras-e2e-ner
---
