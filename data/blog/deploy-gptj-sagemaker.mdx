...
tags:
  ...
  - GPTJ
draft: false
summary: Learn how to deploy EleutherAIs GPT-J 6B for inference using Hugging Face Transformers and Amazon SageMaker.
images: ['/static/blog/deploy-gptj-sagemaker/cover.jpg']
repository: https://github.com/philschmid/amazon-sagemaker-gpt-j-sample
---
