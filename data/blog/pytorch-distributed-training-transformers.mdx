...
tags:
  ...
  - PyTorch
draft: false
summary: Learn how to run large-scale distributed training using multilingual BERT on over 1 million data points with Hugging Face Transformers & Amazon SageMaker
repository: https://github.com/philschmid/transformers-pytorch-text-classification
---
