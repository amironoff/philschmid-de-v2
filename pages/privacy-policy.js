  ...
  return (
    <>
      ...
      <div className="mx-auto lg:container">
        ...
        <br />
        <br />
        <h2 className="text-2xl font-bold">1. An overview of data protection</h2>
        <br></br>
        ...
        <h3 className="text-2xl font-bold">Data recording on this website</h3>
        <h4>
        ...
        <p>
          ...
          site was accessed). This information is recorded automatically when you access this
          website.
        </p>
        ...
        <p>
          ...
          You also have the right to demand that your data are rectified or eradicated. Please do
          not hesitate to contact us at any time under the address disclosed in section „Information
        ...
        <h3 className="text-2xl font-bold">Analysis tools and tools provided by third parties</h3>
        <p>
          There is a possibility that your browsing patterns will be statistically analysed when
          your visit this website. Such analyses are performed primarily with cookies and with what
          we refer to as analysis programmes. As a rule, the analyses of your browsing patterns are
          conducted anonymously; i.e. the browsing patterns cannot be traced back to you.
        </p>
        <br></br>
        <p>
          You have the option to object to such analyses or you can prevent their performance by not
          using certain tools. For detailed information about the tools and about your options to
          object, please consult our Data Protection Declaration below.
        </p>
        <h2 className="text-2xl font-bold">2. Hosting</h2>
        <h3 className="text-2xl font-bold">External Hosting</h3>
        <p>
        ...
        <p>
          ...
          existing customers (Art. 6 para. 1 lit. b DSGVO) and in the interest of secure, fast and
          efficient provision of our online services by a professional provider (Art. 6 para. 1 lit.
          f DSGVO).
        </p>
        <br></br>
        <p>
        ...
        <h2 className="text-2xl font-bold">3. General information and mandatory information</h2>
        ...
        <h3 className="text-2xl font-bold">Revocation of your consent to the processing of data</h3>
        <p>
          ...
          all you are required to do is sent us an informal notification via e-mail. This shall be
        ...
        <p>
          ...
          EXERCISING OR DEFENCE OF LEGAL ENTITLEMENTS (OBJECTION PURSUANT TO ART. 21 SECT. 1 GDPR).
        ...
        <p>
          In the event of violations of the GDPR, data subjects are entitled to log a complaint with
          a supervisory agency, in particular in the member state where they usually maintain their
        ...
        <h3 className="text-2xl font-bold">Right to data portability</h3>
        <p>
        ...
        <h3 className="text-2xl font-bold">SSL and/or TLS encryption</h3>
        <p>
          ...
          either an SSL or a TLS encryption programme. You can recognise an encrypted connection by
        ...
        <h3 className="text-2xl font-bold">Right to demand processing restrictions</h3>
        <p>
        ...
        <h2 className="text-2xl font-bold">4. Recording of data on this website</h2>
        ...
        <p>
          ...
          our website more user friendly, effective and more secure. Cookies are small text files
          ...
          after your leave our site. Other cookies will remain archived on your device until you
          delete them. These cookies enable us to recognise your browser the next time you visit our
          website.
          <br />
          <br />
          You can adjust the settings of your browser to make sure that you are notified every time
          cookies are placed and to enable you to accept cookies only in specific cases or to
          exclude the acceptance of cookies for specific situations or in general and to activate
          the automatic deletion of cookies when you close your browser. If you deactivate cookies,
          ...
          or to provide certain functions you want to use (e.g. the shopping cart function), are
          stored on the basis of Art. 6 Sect. 1 lit. f GDPR. The website operator has a legitimate
          interest in storing cookies to ensure the technically error free and optimised provision
          of the operator’s services. If a corresponding agreement has been requested (e.g. an
          agreement to the storage of cookies), the processing takes place exclusively on the basis
        ...
        <h3 className="text-2xl font-bold">Cookie Consent with Borlabs Cookie</h3>
        <p>
          Our website uses the Borlabs cookie consent technology to obtain your consent to the
          storage of certain cookies in your browser and for their data privacy protection compliant
          documentation. The provider of this technology is Borlabs – Benjamin A. Bornschein,
          Georg-Wilhelm-Str. 17, 21107 Hamburg, Germany (hereinafter referred to as Borlabs).
          <br />
          <br />
          Whenever you visit our website, a Borlabs cookie will be stored in your browser, which
          archives any declarations or revocations of consent you have entered. These data are not
          shared with the provider of the Borlabs technology.
          <br />
          <br />
          The recorded data shall remain archived until you ask us to eradicate them, delete the
          Borlabs cookie on your own or the purpose of storing the data no longer exists. This shall
          be without prejudice to any retention obligations mandated by law. To review the details
          of Borlabs’ data processing policies, please visit
          https://de.borlabs.io/kb/welche-daten-speichert-borlabs-cookie/
          <br />
          <br />
          We use the Borlabs cookie consent technology to obtain the declarations of consent
          mandated by law for the use of cookies. The legal basis for the use of such cookies is
          Art. 6 Sect. 1 Sentence 1 lit. c GDPR.
        </p>
        <h3 className="text-2xl font-bold">Server log files</h3>
        <p>
        ...
        <p>
          ...
          order to handle your inquiry and in the event that we have further questions. We will not
          ...
          effective processing of the requests addressed to us (Art. 6 Para. 1 lit. f DSGVO) or on
          ...
          for which the information is being archived no longer exists (e.g. after we have concluded
        ...
        <h3 className="text-2xl font-bold">Registration on this website</h3>
        <p>
        ...
        <h3 className="text-2xl font-bold">The comment function on this website</h3>
        <p>
          When you use the comment function on this website, information on the time the comment was
          generated and, if you are not posting anonymously, the user name you have selected will be
          archived in addition to your comments.
        </p>
        <h4>Subscribing to comments</h4>
        <p>
          As a user of this website, you have the option to subscribe to comments after you have
          registered. You will receive a confirmation e-mail, the purpose of which is to verify
          whether you are the actual holder of the provided e-mail address. You can deactivate this
          function at any time by following a respective link in the information e-mails. The data
          entered in conjunction with subscriptions to comments will be deleted in this case.
          However, if you have communicated this information to us for other purposes and from a
          different location (e.g. when subscribing to the newsletter), the data shall remain in our
          possession.
        </p>
        ...
        <h2 className="text-2xl font-bold">5. Analysis tools and advertising</h2>
        ...
        <p>
          ...
          prevents the recording of your data during future visits to this website: Google Analytics
          deactivation.
        ...
        {/* <h3 className='text-2xl font-bold'>Google AdSense (not personalized)</h3>
        <p>
        ...
        <h3 className='text-2xl font-bold'>Google Ads and Google Conversion Tracking</h3>
        <p>
        ...
        <h2 className="text-2xl font-bold">6. Newsletter</h2>
        <h3 className="text-2xl font-bold">Newsletter data</h3>
        <p>
          If you would like to subscribe to the newsletter offered on this website, we will need
          from you an e-mail address as well as information that allow us to verify that you are the
          owner of the e-mail address provided and consent to the receipt of the newsletter. No
          further data shall be collected or shall be collected only on a voluntary basis. We shall
          use such data only for the sending of the requested information and shall not share such
          ...
          revoke the consent you have given to the archiving of data, the e-mail address and the use
          of this information for the sending of the newsletter at any time, for instance by
          clicking on the „Unsubscribe“ link in the newsletter. This shall be without prejudice to
        ...
        <h3 className="text-2xl font-bold">MailChimp</h3>
        <p>
          ...
          <br />
          <br />
          Among other things, MailChimp is a service that can be deployed to organise and analyse
          ...
          the United States. MailChimp is in possession of a certification that is in compliance
          with the „EU-US-Privacy-Shield.“ The „Privacy-Shield“ is a compact between the European
          Union (EU) and the United States of America (USA) that aims to warrant the compliance with
          European data protection standards in the United States.
          <br />
          <br />
          With the assistance of the MailChimp tool, we can analyse the performance of our
          newsletter campaigns. If you open an e-mail that has been sent through the MailChimp tool,
          a file that has been integrated into the e-mail (a so-called web-beacon) connects to
          ...
          Technical information is also recorded at that time (e.g. the time of access, the IP
          address, type of browser and operating system). This information cannot be allocated to
          the respective newsletter recipient. Their sole purpose is the performance of statistical
          ...
          you can also unsubscribe from the newsletter right on the website. The data is processed
          based on your consent (Art. 6 Sect. 1 lit. a GDPR). You may revoke any consent you have
          given at any time by unsubscribing from the newsletter. This shall be without prejudice to
          the lawfulness of any data processing transactions that have taken place prior to your
          revocation. The data deposited with us for the purpose of subscribing to the newsletter
          will be stored by us until you unsubscribe from the newsletter or the newsletter service
          provider and deleted from the newsletter distribution list after you unsubscribe from the
          ...
          mandate that MailChimp undertakes to protect the data of our customers and to refrain from
          sharing it with third parties.
        </p>
        <h2 className="text-2xl font-bold">7. Plug-ins and Tools</h2>
        <h3 className="text-2xl font-bold">Google Web Fonts</h3>
        <p>
          To ensure that fonts used on this website are uniform, this website uses so-called Web
          ...
          <br />
          <br />
          To do this, the browser you use will have to establish a connection with Google’s servers.
          As a result, Google will learn that your IP address was used to access this website. The
          use of Google Web Fonts is based on our interest in presenting our online content in a
          uniform and appealing way. According to Art. 6 Sect. 1 lit. f GDPR, this is a legitimate
          interest.
          <br />
          <br />
          If your browser should not support Web Fonts, a standard font installed on your computer
          will be used. For more information on Google Web Fonts, please follow this link:
        ...
        <h2 className="text-2xl font-bold">8. Online marketing and partner programmes</h2>
        <h3 className="text-2xl font-bold">Amazon partner programme</h3>
        <p>
          The operators of this website participate in the Amazon EU partners’ programme. Amazon
          integrates ads and links to the German Amazon website – Amazon.de – into this website,
          which allows us to generate earnings in the form of advertising cost reimbursements.
          Amazon uses cookies for this programme to be able to determine the source of orders
          placed. This allows Amazon to determine that you have clicked the partner link on this
          website. The archiving of „Amazon cookies“ is based on Art. 6 lit. f GDPR. Based on the
          aforementioned regulation, the website operator has a legitimate interest to do this since
          the determination of the website operator’s affiliate earnings is contingent upon the
          placement of cookies.
          <br />
          <br />
          For more information on Amazon’s data usage, please consult Amazon’s Data Privacy
          Declaration under the following link:
